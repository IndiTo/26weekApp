...
function App() {
  ...
  {
          cards.map((cards) =>
        <Cards name={cards.name} universe={cards.universe} alterego={cards.alterego} occupation={cards.occupation} friends={cards.friends} superpowers={cards.superpowers} url={cards.url} info={cards.info}></Cards>
          )
      }
